...
\citep{gupta2007quantifying}. The distance between ungapped alignment of
columns from two motifs is computed by summing the column comparison scores
...
We use two standard metrics for classification
